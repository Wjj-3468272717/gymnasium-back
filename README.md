...
| `member_card` | 🏷️ 会员卡类型 | title, card_type, price, card_day |
...
### ⚙️ 前置条件
- ☕ JDK 1.8+
- 🗄️ MySQL 8.0（执行 `scripts/gym.sql` 一键建库建表）
- 🖼️ MinIO（图片存储，可选）
- 🌐 Nacos 1.4.2
...
![Nacos 配置](README.assets/image-20260802005833361.png)
...
- 🧪 API 测试: `curl http://localhost:9999/api/login/image -X POST` ✅

![Nacos 服务列表](README.assets/image-20260802010621371.png)

![Swagger API](README.assets/image-20260802010825884.png)
...
> 💡 登录时选择对应类型（员工/会员），验证码从 gym-service-web 控制台日志输出中获取 `(╯▽╰)`
...
**现象：** 大量 500 错误，`xxx.getUserType().equals("1")` NPE 💥

**原因：** 前端可能不传 `userType` 参数，导致 `null.equals()`。

**解决：** 全局替换为 `"1".equals(xxx.getUserType())` 安全调用模式 🛡️
...
`帕梅拉酷我健身-在线管理系统` 的诞生离不开开源软件和社区的支持，感谢以下开源项目及维护者 (´▽`ʃ♡ƪ)：

- 🍃 `Spring`：https://github.com/spring-projects
- 🏗️ `Apache Dubbo`：https://github.com/apache/dubbo
- 🌐 `Alibaba Nacos`：https://github.com/alibaba/nacos
- 🗄️ `MyBatis-Plus`：https://github.com/baomidou
- 🔐 `Spring Security`：https://github.com/spring-projects/spring-security
- 🎨 `Vue`：https://github.com/vuejs
- 🖼️ `Element Plus`：https://github.com/element-plus
- 📦 `MinIO`：https://github.com/minio
- 🔌 `Druid`：https://github.com/alibaba/druid

特别感谢 **JetBrains** 提供的教育许可证，让本项目的开发效率大幅提升！🚀

> 🎓 Licensed under JetBrains Educational License
